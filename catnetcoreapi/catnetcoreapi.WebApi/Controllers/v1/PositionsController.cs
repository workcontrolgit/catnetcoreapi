...
using catnetcoreapi.Application.Features.Positions.Commands.DeletePositionById;
using catnetcoreapi.Application.Features.Positions.Commands.UpdatePosition;
using catnetcoreapi.Application.Features.Positions.Queries.GetPositionById;
...
namespace catnetcoreapi.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
